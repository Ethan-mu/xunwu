...
public class HouseController {
   ...
   @GetMapping("rent/house/map")
    public String rentMapPage(@RequestParam(value ="cityEnName")String cityEnName,
            ...
            ServiceMultiResult<SupportAddressDTO> reginons=addressService
       ...
       ServiceMultiResult<HouseBucketDTO> serviceMultiResult=searchService.mapAggregate(cityEnName);
            ...
            model.addAttribute("aggDate", serviceMultiResult.getResult());
            model.addAttribute("total",serviceMultiResult.getTotal());
            model.addAttribute("regions",reginons.getResult());
            return "rent-map";
